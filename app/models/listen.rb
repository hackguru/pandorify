class Listen < ActiveRecord::Base
  ...
  scope :sorted_based_on_song,
        ...
        :group => "#{Song.table_name}.identifier, #{Song.table_name}.title, #{Song.table_name}.url, #{Song.table_name}.created_at, #{Song.table_name}.updated_at, #{Song.table_name}.application_id",
